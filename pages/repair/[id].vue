<template>
    <div
        class="gridClass laptop:my-16 flex flex-col gap-8 relative pb-[140px] laptop:pb-0 w-full"
    >
        <BaseBreadcrumb
    ...
    return [
        ...
        // },
        {
            ...
            data: {
                ...
                addressArray: [ selectedAddress?.postalCode, selectedAddress?.address, selectedAddress?.city, selectedAddress?.country ]
            },
        },
    ];
});
