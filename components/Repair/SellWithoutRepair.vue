      ...
      >
        ...
        >
          <div class="flex flex-col gap-4 w-full">
            ...
            />
            <div
              class="flex flex-col laptop:flex-row w-full items-center gap-4 laptop:p-10"
            >
              <NuxtImg
                alt=""
              ...
              />
              <div
                class="flex flex-col gap-4 leading-normal text-center w-full laptop:text-start"
              >
                <div
          ...
          >
            <div>
              <BaseButton
                buttonId="identify-sell-without-repair-back"
                size="s"
                styleType="outlined"
                :text="$t('Back')"
                @click="$emit('back')"
            ...
            <BaseButton
              size="s"
              buttonId="identify-sell-without-repair-submit"
              type="submit"
              :text="$t('Submit')"
              :isLoading="isLoading"
              @click="selectSize"
